...
class CreateOrderWebhook extends Controller
{
  ...
  public function handle(Request $request)
  {
    ...
    try {
      ...
      InProgressOrder::create([
        ...
        'address'       => $order['custom_fields']['address_name'] ?? null,
        'country_name'  => "Việt Nam",
        'state_name'    => $order['custom_fields']['state_name'] ?? null,
        'district_name' => null,
        'ward_name'     => $order['custom_fields']['ward_name'] ?? null,
